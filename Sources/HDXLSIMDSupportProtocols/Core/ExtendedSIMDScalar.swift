...
public protocol ExtendedSIMDScalar : SIMDScalar, BinaryFloatingPoint, Codable {
  ...
  associatedtype QuaternionStorage: QuaternionProtocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
    QuaternionStorage.CompatibleMatrix4x4 == Self.Matrix4x4Storage,
    QuaternionStorage.CompatibleMatrix3x3 == Self.Matrix3x3Storage
  
  associatedtype Matrix2x2Storage: Matrix2x2Protocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
  ...
  associatedtype Matrix2x3Storage: Matrix2x3Protocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
  ...
  associatedtype Matrix2x4Storage: Matrix2x4Protocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
  ...
  associatedtype Matrix3x2Storage: Matrix3x2Protocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
  ...
  associatedtype Matrix3x3Storage: Matrix3x3Protocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
  ...
  associatedtype Matrix3x4Storage: Matrix3x4Protocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
  ...
  associatedtype Matrix4x2Storage: Matrix4x2Protocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
  ...
  associatedtype Matrix4x3Storage: Matrix4x3Protocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
  ...
  associatedtype Matrix4x4Storage: Matrix4x4Protocol<Self>, NumericAggregate<Self>, Hashable, Codable
    where
