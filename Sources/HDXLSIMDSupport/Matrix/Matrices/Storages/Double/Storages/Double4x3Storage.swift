...
// -------------------------------------------------------------------------- //
// MARK: Double4x3Storage - Definition
// -------------------------------------------------------------------------- //

public struct Double4x3Storage {
  
  public typealias Storage = simd_double4x3
...
// -------------------------------------------------------------------------- //
// MARK: Double4x3Storage - NativeSIMDRepresentable
// -------------------------------------------------------------------------- //

extension Double4x3Storage : NativeSIMDRepresentable {
...
// -------------------------------------------------------------------------- //
// MARK: Double4x3Storage - SIMDMatrix4x3StorageProtocol
// -------------------------------------------------------------------------- //

extension Double4x3Storage : SIMDMatrix4x3StorageProtocol {
  ...
  public typealias TransposeStorage = Double3x4Storage
  ...
  public init(columns: [ColumnVector]) {
    precondition(columns.count == Double4x3Storage.columnCount)
    self.storage = Storage(
      columns[0],
      columns[1],
      columns[2],
  ...
  public init(rows: [RowVector]) {
    precondition(rows.count == Double4x3Storage.rowCount)
    self.storage = Storage(
      rows: [
        rows[0],
        rows[1],
  ...
  public init(arrayLiteral elements: Scalar...) {
    guard elements.count == type(of: self).scalarCount else {
      fatalError("Invalid array-literal construction: \(String(reflecting: elements)) supplied-to `Double4x3Storage`!")
    }
  ...
  public var description: String {
    get {
      return "Double4x3Storage(storage: \(String(describing: self.storage)))"
    }
  }
  ...
  public var debugDescription: String {
    get {
      return "Double4x3Storage(storage: \(String(reflecting: self.storage)))"
    }
  }
  ...
  public subscript(columnIndex columnIndex: Int) -> ColumnVector {
    get {
      precondition(Double4x3Storage.columnIndexRange.contains(columnIndex))
      switch columnIndex {
      case 0:
  ...
  public subscript(columnIndex columnIndex: Int, rowIndex rowIndex: Int) -> Scalar {
    get {
      precondition(Double4x3Storage.columnIndexRange.contains(columnIndex))
      precondition(Double4x3Storage.rowIndexRange.contains(rowIndex))
      switch columnIndex {
      case 0:
  ...
  @inlinable
  public func negated() -> Double4x3Storage {
    return Double4x3Storage(
  ...
  @inlinable
  public func adding(_ other: Double4x3Storage) -> Double4x3Storage {
    return Double4x3Storage(
  ...
  @inlinable
  public mutating func formAddition(of other: Double4x3Storage) {
    self.storage += other.storage
  }
  
  @inlinable
  public func adding(
    _ other: Double4x3Storage,
    multipliedBy factor: Scalar) -> Double4x3Storage {
    return Double4x3Storage(
  ...
  public mutating func formAddition(
    of other: Double4x3Storage,
    multipliedBy factor: Scalar) {
    self.storage += (other.storage * factor)
  }
  
  @inlinable
  public func subtracting(_ other: Double4x3Storage) -> Double4x3Storage {
    return Double4x3Storage(
  ...
  @inlinable
  public mutating func formSubtraction(of other: Double4x3Storage) {
    self.storage -= other.storage
  }
  
  @inlinable
  public func multiplied(by factor: Scalar) -> Double4x3Storage {
    return Double4x3Storage(
