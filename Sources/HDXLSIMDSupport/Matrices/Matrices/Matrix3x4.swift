  ...
  VectorArithmetic
{
  ...
  public var description: String {
    get {
      return "Matrix3x4: \(String(describing: nativeSIMDRepresentation))"
    }
  }
  ...
  public var debugDescription: String {
    get {
      return "Matrix3x4<\(String(reflecting: Scalar.self))>(nativeSIMDRepresentation: \(String(reflecting: nativeSIMDRepresentation)))"
    }
  }
