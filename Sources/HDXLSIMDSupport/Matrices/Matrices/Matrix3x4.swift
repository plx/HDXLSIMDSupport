...
public struct Matrix3x4<Scalar:ExtendedSIMDScalar>  :
  ...
  public typealias PassthroughValue = Scalar.Matrix3x4Storage
  ...
  public var description: String {
    get {
      return "Matrix3x4: \(String(describing: self.nativeSIMDRepresentation))"
    }
  }
  ...
  public var debugDescription: String {
    get {
      return "Matrix3x4<\(String(reflecting: Scalar.self))>(nativeSIMDRepresentation: \(String(reflecting: self.nativeSIMDRepresentation)))"
    }
  }
  
  @inlinable
  public static var zero: Matrix3x4<Scalar> {
    get {
      return Matrix3x4<Scalar>()
    }
  }
