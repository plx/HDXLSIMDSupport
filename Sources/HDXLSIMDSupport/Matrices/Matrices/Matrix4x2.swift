...
public struct Matrix4x2<Scalar:ExtendedSIMDScalar>  :
  ...
  public var description: String {
    get {
      return "Matrix4x2: \(String(describing: self.nativeSIMDRepresentation))"
    }
  }
  ...
  public var debugDescription: String {
    get {
      return "Matrix4x2<\(String(reflecting: Scalar.self))>(nativeSIMDRepresentation: \(String(reflecting: self.nativeSIMDRepresentation)))"
    }
  }
