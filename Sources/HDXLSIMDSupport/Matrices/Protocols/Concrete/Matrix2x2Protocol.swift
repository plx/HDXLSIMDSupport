...
public protocol Matrix2x2Protocol : MatrixProtocol
  where
  ...
  associatedtype CompatibleMatrix2x3 /* : Matrix2x3Protocol where ...  */
  
  /// Type of the directly-compatible 3x2 matrix.
  associatedtype CompatibleMatrix3x2 /* : Matrix3x2Protocol where...  */
