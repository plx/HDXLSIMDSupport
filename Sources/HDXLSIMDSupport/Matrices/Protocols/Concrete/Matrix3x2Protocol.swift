...
public protocol Matrix3x2Protocol : MatrixProtocol
  where
  ...
  Columns == T3<ColumnVector>
{
  ...
  func multiplied(onLeftBy lhs: CompatibleMatrix2x3) -> CompatibleMatrix3x3
  
  /// Returns the `3x4`-sized result of `lhs * self`.
  func multiplied(onLeftBy lhs: CompatibleMatrix2x4) -> CompatibleMatrix3x4
