...
public protocol Matrix4x3Protocol : MatrixProtocol
  where
  ...
  Columns == T4<ColumnVector>
{
  ...
  associatedtype CompatibleMatrix2x3 /*: Matrix2x3Protocol */
  
  /// Type of the directly-compatible 3x2 matrix.
  associatedtype CompatibleMatrix3x2 /*: Matrix3x2Protocol */
  
  /// Type of the directly-compatible 2x4 matrix.
  associatedtype CompatibleMatrix2x4 /*: Matrix2x4Protocol */
  
  /// Type of the compatible 4x2 matrix.
  associatedtype CompatibleMatrix4x2 /*: Matrix4x2Protocol */

  /// Type of the directly-compatible 3x4 matrix.
  associatedtype CompatibleMatrix3x4 /*: Matrix3x4Protocol */
