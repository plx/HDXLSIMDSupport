...
extension simd_float2x3 : MatrixDefaultSupportProtocol, Matrix2x3Protocol {
  ...
  public init(linearizedScalars: [Scalar]) {
    ...
    self.init(
      columnVectors: simd_float2x3.columnVectors(
  ...
  public static func linearCombination(
    of first: simd_float2x3,
    weight firstWeight: Scalar,
    with other: simd_float2x3,
    weight otherWeight: Scalar) -> simd_float2x3 {
  ...
  public subscript(rowIndex rowIndex: Int) -> RowVector {
    get {
      precondition(simd_float2x3.rowIndexRange.contains(rowIndex))
      return RowVector(
  ...
  // we supply:
  @inlinable
  public func negated() -> simd_float2x3 {
    return -self
  }
  ...
  // we supply:
  @inlinable
  public func adding(_ other: simd_float2x3) -> simd_float2x3 {
    return self + other
  }
  
  // we supply:
  @inlinable
  public mutating func formAddition(of other: simd_float2x3) {
    self += other
  }
  ...
  @inlinable
  public func adding(
    _ other: simd_float2x3,
    multipliedBy scalar: Scalar) -> simd_float2x3 {
  ...
  // we supply:
  @inlinable
  public func subtracting(_ other: simd_float2x3) -> simd_float2x3 {
    return self - other
  }
  
  // we supply:
  @inlinable
  public mutating func formSubtraction(of other: simd_float2x3) {
    self -= other
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(by scalar: Scalar) -> simd_float2x3 {
    return self * scalar
  }
  ...
  // we supply:
  @inlinable
  public func divided(by scalar: Scalar) -> simd_float2x3 {
  ...
  // we supply:
  @inlinable
  public func transposed() -> simd_float3x2 {
  ...
  @inlinable
  public func multiplied(onLeftBy lhs: CompatibleMatrix3x3) -> simd_float2x3 {
    return lhs * self
  }
