...
extension simd_float2x4 : MatrixDefaultSupportProtocol, Matrix2x4Protocol {
  ...
  public init(linearizedScalars: [Scalar]) {
    ...
    self.init(
      columnVectors: simd_float2x4.columnVectors(
  ...
  // we supply:
  nonisolated(unsafe) public static let matrixPositions: [MatrixPosition] = simd_float2x4.prepareMatrixPositionList()
  ...
  // we supply:
  @inlinable
  public func negated() -> simd_float2x4 {
    return -self
  }
  ...
  // we supply:
  @inlinable
  public func adding(_ other: simd_float2x4) -> simd_float2x4 {
    return self + other
  }
  
  // we supply:
  @inlinable
  public mutating func formAddition(of other: simd_float2x4) {
    self += other
  }
  ...
  // we supply:
  @inlinable
  public func subtracting(_ other: simd_float2x4) -> simd_float2x4 {
    return self - other
  }
  
  // we supply:
  @inlinable
  public mutating func formSubtraction(of other: simd_float2x4) {
    self -= other
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(by scalar: Scalar) -> simd_float2x4 {
    return self * scalar
  }
  ...
  // we supply:
  @inlinable
  public func divided(by scalar: Scalar) -> simd_float2x4 {
  ...
  @inlinable
  public func multiplied(onRightBy rhs: CompatibleMatrix2x2) -> simd_float2x4 {
    return self * rhs
  }
  ...
  @inlinable
  public func multiplied(onLeftBy lhs: CompatibleMatrix4x4) -> simd_float2x4 {
    return lhs * self
  }
