...
extension simd_float4x4 : MatrixDefaultSupportProtocol, Matrix4x4Protocol {
  ...
  public init(linearizedScalars: [Scalar]) {
    ...
    self.init(
      columnVectors: simd_float4x4.columnVectors(
  ...
  public static func linearCombination(
    ...
    weight otherWeight: Scalar) -> simd_float4x4 {
  ...
  public subscript(rowIndex rowIndex: Int) -> RowVector {
    get {
      precondition(simd_float4x4.rowIndexRange.contains(rowIndex))
      return RowVector(
  ...
  // we supply:
  public static let matrixPositions: [MatrixPosition] = simd_float4x4.prepareMatrixPositionList()
  ...
  // we supply:
  @inlinable
  public func negated() -> simd_float4x4 {
    return -self
  }
  ...
  // we supply:
  @inlinable
  public func adding(_ other: simd_float4x4) -> simd_float4x4 {
    return self + other
  }
  
  // we supply:
  @inlinable
  public mutating func formAddition(of other: simd_float4x4) {
    self += other
  }
  ...
  public func adding(
    ...
    multipliedBy scalar: Scalar) -> simd_float4x4 {
  ...
  // we supply:
  @inlinable
  public func subtracting(_ other: simd_float4x4) -> simd_float4x4 {
    return self - other
  }
  
  // we supply:
  @inlinable
  public mutating func formSubtraction(of other: simd_float4x4) {
    self -= other
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(by scalar: Scalar) -> simd_float4x4 {
    return self * scalar
  }
  ...
  // we supply:
  @inlinable
  public func divided(by scalar: Scalar) -> simd_float4x4 {
  ...
  // we supply:
  @inlinable
  public func inverted() -> simd_float4x4 {
    return self.inverse
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(onRightBy rhs: simd_float4x4) -> simd_float4x4 {
    return self * rhs
  }
  
  // we supply:
  @inlinable
  public func multiplied(onLeftBy lhs: simd_float4x4) -> simd_float4x4 {
    return lhs * self
  }
  
  // we supply:
  @inlinable
  public mutating func formMultiplication(onRightBy rhs: simd_float4x4) {
    self = self * rhs
  }
  
  // we supply:
  @inlinable
  public mutating func formMultiplication(onLeftBy lhs: simd_float4x4) {
    self = lhs * self
  }
  ...
  // we supply:
  @inlinable
  public func divided(onRightBy rhs: simd_float4x4) -> simd_float4x4 {
    return self * rhs.inverse
  }
  
  // we supply:
  @inlinable
  public func divided(onLeftBy lhs: simd_float4x4) -> simd_float4x4 {
    return lhs.inverse * self
  }
  
  // we supply:
  @inlinable
  public mutating func formDivision(onRightBy rhs: simd_float4x4) {
    self = self * rhs.inverse
  }
  
  // we supply:
  @inlinable
  public mutating func formDivision(onLeftBy lhs: simd_float4x4) {
  ...
  // we supply:
  @inlinable
  public func transposed() -> simd_float4x4 {
