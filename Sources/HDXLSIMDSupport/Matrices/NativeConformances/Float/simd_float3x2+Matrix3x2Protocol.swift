...
extension simd_float3x2 : MatrixDefaultSupportProtocol, Matrix3x2Protocol {
  ...
  public init(linearizedScalars: [Scalar]) {
    ...
    self.init(
      columnVectors: simd_float3x2.columnVectors(
  ...
  public static func linearCombination(
    ...
    weight otherWeight: Scalar) -> simd_float3x2 {
  ...
  public subscript(rowIndex rowIndex: Int) -> RowVector {
    get {
      precondition(simd_float3x2.rowIndexRange.contains(rowIndex))
      return RowVector(
  ...
  // we supply:
  public static let matrixPositions: [MatrixPosition] = simd_float3x2.prepareMatrixPositionList()
  ...
  // we supply:
  @inlinable
  public func negated() -> simd_float3x2 {
    return -self
  }
  ...
  // we supply:
  @inlinable
  public func adding(_ other: simd_float3x2) -> simd_float3x2 {
    return self + other
  }
  
  // we supply:
  @inlinable
  public mutating func formAddition(of other: simd_float3x2) {
    self += other
  }
  ...
  public func adding(
    ...
    multipliedBy scalar: Scalar) -> simd_float3x2 {
  ...
  // we supply:
  @inlinable
  public func subtracting(_ other: simd_float3x2) -> simd_float3x2 {
    return self - other
  }
  
  // we supply:
  @inlinable
  public mutating func formSubtraction(of other: simd_float3x2) {
    self -= other
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(by scalar: Scalar) -> simd_float3x2 {
    return self * scalar
  }
  ...
  // we supply:
  @inlinable
  public func divided(by scalar: Scalar) -> simd_float3x2 {
  ...
  // we supply:
  @inlinable
  public func transposed() -> simd_float2x3 {
  ...
  @inlinable
  public func multiplied(onRightBy rhs: CompatibleMatrix3x3) -> simd_float3x2 {
    return self * rhs
  }
  ...
  @inlinable
  public func multiplied(onLeftBy lhs: CompatibleMatrix2x2) -> simd_float3x2 {
    return lhs * self
  }
