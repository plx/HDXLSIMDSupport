...
extension simd_float3x3 : MatrixDefaultSupportProtocol, Matrix3x3Protocol {
  ...
  public init(linearizedScalars: [Scalar]) {
    ...
    self.init(
      columnVectors: simd_float3x3.columnVectors(
  ...
  public static func linearCombination(
    of first: simd_float3x3,
    weight firstWeight: Scalar,
    with other: simd_float3x3,
    weight otherWeight: Scalar) -> simd_float3x3 {
  ...
  public subscript(rowIndex rowIndex: Int) -> RowVector {
    get {
      precondition(simd_float3x3.rowIndexRange.contains(rowIndex))
      return RowVector(
  ...
  // we supply:
  public static let matrixPositions: [MatrixPosition] = simd_float3x3.prepareMatrixPositionList()
  ...
  // we supply:
  @inlinable
  public func negated() -> simd_float3x3 {
    return -self
  }
  ...
  // we supply:
  @inlinable
  public func adding(_ other: simd_float3x3) -> simd_float3x3 {
    return self + other
  }
  
  // we supply:
  @inlinable
  public mutating func formAddition(of other: simd_float3x3) {
    self += other
  }
  ...
  @inlinable
  public func adding(
    _ other: simd_float3x3,
    multipliedBy scalar: Scalar) -> simd_float3x3 {
  ...
  // we supply:
  @inlinable
  public func subtracting(_ other: simd_float3x3) -> simd_float3x3 {
    return self - other
  }
  
  // we supply:
  @inlinable
  public mutating func formSubtraction(of other: simd_float3x3) {
    self -= other
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(by scalar: Scalar) -> simd_float3x3 {
    return self * scalar
  }
  ...
  // we supply:
  @inlinable
  public func divided(by scalar: Scalar) -> simd_float3x3 {
  ...
  public typealias CompatibleQuaternion = simd_quatf
  ...
  // we supply:
  @inlinable
  public func inverted() -> simd_float3x3 {
    return self.inverse
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(onRightBy rhs: simd_float3x3) -> simd_float3x3 {
    return self * rhs
  }
  
  // we supply:
  @inlinable
  public func multiplied(onLeftBy lhs: simd_float3x3) -> simd_float3x3 {
    return lhs * self
  }
  
  // we supply:
  @inlinable
  public mutating func formMultiplication(onRightBy rhs: simd_float3x3) {
    self = self * rhs
  }
  
  // we supply:
  @inlinable
  public mutating func formMultiplication(onLeftBy lhs: simd_float3x3) {
    self = lhs * self
  }
  ...
  // we supply:
  @inlinable
  public func divided(onRightBy rhs: simd_float3x3) -> simd_float3x3 {
    return self * rhs.inverse
  }
  
  // we supply:
  @inlinable
  public func divided(onLeftBy lhs: simd_float3x3) -> simd_float3x3 {
    return lhs.inverse * self
  }
  
  // we supply:
  @inlinable
  public mutating func formDivision(onRightBy rhs: simd_float3x3) {
    self = self * rhs.inverse
  }
  
  // we supply:
  @inlinable
  public mutating func formDivision(onLeftBy lhs: simd_float3x3) {
  ...
  // we supply:
  @inlinable
  public func transposed() -> simd_float3x3 {
