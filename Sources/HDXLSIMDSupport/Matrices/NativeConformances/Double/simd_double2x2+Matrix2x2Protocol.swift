...
extension simd_double2x2 : MatrixDefaultSupportProtocol, Matrix2x2Protocol {
  ...
  public init(linearizedScalars: [Scalar]) {
    ...
    self.init(
      columnVectors: simd_double2x2.columnVectors(
  ...
  public static func linearCombination(
    of first: simd_double2x2,
    weight firstWeight: Scalar,
    with other: simd_double2x2,
    weight otherWeight: Scalar) -> simd_double2x2 {
  ...
  public subscript(rowIndex rowIndex: Int) -> RowVector {
    get {
      precondition(simd_double2x2.rowIndexRange.contains(rowIndex))
      return RowVector(
  ...
  // we supply:
  @inlinable
  public func negated() -> simd_double2x2 {
    return -self
  }
  ...
  // we supply:
  @inlinable
  public func adding(_ other: simd_double2x2) -> simd_double2x2 {
    return self + other
  }
  
  // we supply:
  @inlinable
  public mutating func formAddition(of other: simd_double2x2) {
    self += other
  }
  ...
  @inlinable
  public func adding(
    _ other: simd_double2x2,
    multipliedBy scalar: Scalar) -> simd_double2x2 {
  ...
  // we supply:
  @inlinable
  public func subtracting(_ other: simd_double2x2) -> simd_double2x2 {
    return self - other
  }
  
  // we supply:
  @inlinable
  public mutating func formSubtraction(of other: simd_double2x2) {
    self -= other
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(by scalar: Scalar) -> simd_double2x2 {
    return self * scalar
  }
  ...
  // we supply:
  @inlinable
  public func divided(by scalar: Scalar) -> simd_double2x2 {
  ...
  // we supply:
  @inlinable
  public func inverted() -> simd_double2x2 {
    return self.inverse
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(onRightBy rhs: simd_double2x2) -> simd_double2x2 {
    return self * rhs
  }
  
  // we supply:
  @inlinable
  public func multiplied(onLeftBy lhs: simd_double2x2) -> simd_double2x2 {
    return lhs * self
  }
  
  // we supply:
  @inlinable
  public mutating func formMultiplication(onRightBy rhs: simd_double2x2) {
    self = self * rhs
  }
  
  // we supply:
  @inlinable
  public mutating func formMultiplication(onLeftBy lhs: simd_double2x2) {
    self = lhs * self
  }
  ...
  // we supply:
  @inlinable
  public func divided(onRightBy rhs: simd_double2x2) -> simd_double2x2 {
    return self * rhs.inverse
  }
  
  // we supply:
  @inlinable
  public func divided(onLeftBy lhs: simd_double2x2) -> simd_double2x2 {
    return lhs.inverse * self
  }
  
  // we supply:
  @inlinable
  public mutating func formDivision(onRightBy rhs: simd_double2x2) {
    self = self * rhs.inverse
  }
  
  // we supply:
  @inlinable
  public mutating func formDivision(onLeftBy lhs: simd_double2x2) {
  ...
  // we supply:
  @inlinable
  public func transposed() -> simd_double2x2 {
