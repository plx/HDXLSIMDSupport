...
extension simd_double4x2 : MatrixDefaultSupportProtocol, Matrix4x2Protocol {
  ...
  public init(linearizedScalars: [Scalar]) {
    ...
    self.init(
      columnVectors: simd_double4x2.columnVectors(
  ...
  // we supply:
  @inlinable
  public func negated() -> simd_double4x2 {
    return -self
  }
  ...
  // we supply:
  @inlinable
  public func adding(_ other: simd_double4x2) -> simd_double4x2 {
    return self + other
  }
  
  // we supply:
  @inlinable
  public mutating func formAddition(of other: simd_double4x2) {
    self += other
  }
  ...
  // we supply:
  @inlinable
  public func subtracting(_ other: simd_double4x2) -> simd_double4x2 {
    return self - other
  }
  
  // we supply:
  @inlinable
  public mutating func formSubtraction(of other: simd_double4x2) {
    self -= other
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(by scalar: Scalar) -> simd_double4x2 {
    return self * scalar
  }
  ...
  // we supply:
  @inlinable
  public func divided(by scalar: Scalar) -> simd_double4x2 {
  ...
  @inlinable
  public func multiplied(onRightBy rhs: CompatibleMatrix4x4) -> simd_double4x2 {
    return self * rhs
  }
  ...
  @inlinable
  public func multiplied(onLeftBy lhs: CompatibleMatrix2x2) -> simd_double4x2 {
    return lhs * self
  }
