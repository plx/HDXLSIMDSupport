...
extension simd_double3x2 : MatrixDefaultSupportProtocol, Matrix3x2Protocol {
  ...
  public init(linearizedScalars: [Scalar]) {
    ...
    self.init(
      columnVectors: simd_double3x2.columnVectors(
  ...
  public static func linearCombination(
    of first: simd_double3x2,
    weight firstWeight: Scalar,
    with other: simd_double3x2,
    weight otherWeight: Scalar) -> simd_double3x2 {
  ...
  public subscript(rowIndex rowIndex: Int) -> RowVector {
    get {
      precondition(simd_double3x2.rowIndexRange.contains(rowIndex))
      return RowVector(
  ...
  // we supply:
  @inlinable
  public func negated() -> simd_double3x2 {
    return -self
  }
  ...
  // we supply:
  @inlinable
  public func adding(_ other: simd_double3x2) -> simd_double3x2 {
    return self + other
  }
  
  // we supply:
  @inlinable
  public mutating func formAddition(of other: simd_double3x2) {
    self += other
  }
  ...
  @inlinable
  public func adding(
    _ other: simd_double3x2,
    multipliedBy scalar: Scalar) -> simd_double3x2 {
  ...
  // we supply:
  @inlinable
  public func subtracting(_ other: simd_double3x2) -> simd_double3x2 {
    return self - other
  }
  
  // we supply:
  @inlinable
  public mutating func formSubtraction(of other: simd_double3x2) {
    self -= other
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(by scalar: Scalar) -> simd_double3x2 {
    return self * scalar
  }
  ...
  // we supply:
  @inlinable
  public func divided(by scalar: Scalar) -> simd_double3x2 {
  ...
  // we supply:
  @inlinable
  public func transposed() -> simd_double2x3 {
  ...
  @inlinable
  public func multiplied(onRightBy rhs: CompatibleMatrix3x3) -> simd_double3x2 {
    return self * rhs
  }
  ...
  @inlinable
  public func multiplied(onLeftBy lhs: CompatibleMatrix2x2) -> simd_double3x2 {
    return lhs * self
  }
