...
extension simd_double4x3 : MatrixDefaultSupportProtocol, Matrix4x3Protocol {
  ...
  public init(linearizedScalars: [Scalar]) {
    ...
    self.init(
      columnVectors: simd_double4x3.columnVectors(
  ...
  public static func linearCombination(
    of first: simd_double4x3,
    weight firstWeight: Scalar,
    with other: simd_double4x3,
    weight otherWeight: Scalar) -> simd_double4x3 {
  ...
  public subscript(rowIndex rowIndex: Int) -> RowVector {
    get {
      precondition(simd_double4x3.rowIndexRange.contains(rowIndex))
      return RowVector(
  ...
  // we supply:
  @inlinable
  public func negated() -> simd_double4x3 {
    return -self
  }
  ...
  // we supply:
  @inlinable
  public func adding(_ other: simd_double4x3) -> simd_double4x3 {
    return self + other
  }
  
  // we supply:
  @inlinable
  public mutating func formAddition(of other: simd_double4x3) {
    self += other
  }
  ...
  @inlinable
  public func adding(
    _ other: simd_double4x3,
    multipliedBy scalar: Scalar) -> simd_double4x3 {
  ...
  // we supply:
  @inlinable
  public func subtracting(_ other: simd_double4x3) -> simd_double4x3 {
    return self - other
  }
  
  // we supply:
  @inlinable
  public mutating func formSubtraction(of other: simd_double4x3) {
    self -= other
  }
  ...
  // we supply:
  @inlinable
  public func multiplied(by scalar: Scalar) -> simd_double4x3 {
    return self * scalar
  }
  ...
  // we supply:
  @inlinable
  public func divided(by scalar: Scalar) -> simd_double4x3 {
  ...
  // we supply:
  @inlinable
  public func transposed() -> simd_double3x4 {
  ...
  @inlinable
  public func multiplied(onRightBy rhs: CompatibleMatrix4x4) -> simd_double4x3 {
    return self * rhs
  }
  ...
  @inlinable
  public func multiplied(onLeftBy lhs: CompatibleMatrix3x3) -> simd_double4x3 {
    return lhs * self
  }
