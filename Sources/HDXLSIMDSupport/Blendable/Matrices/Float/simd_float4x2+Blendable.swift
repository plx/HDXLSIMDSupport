...
// -------------------------------------------------------------------------- //
// MARK: simd_float4x2 - Blendable
// -------------------------------------------------------------------------- //

extension simd_float4x2 : Blendable {
  
  public typealias BlendingWeight = NativeSIMDScalar
  
  @inlinable
  public init(
    byBlending first: simd_float4x2,
  ...
  @inlinable
  public init(
    byInterpolatingFrom start: simd_float4x2,
    towards limit: simd_float4x2,
  ...
  public func incorporating(
    ...
    at weight: BlendingWeight) -> simd_float4x2 {
  ...
  public func blended(
    ...
    with other: simd_float4x2,
    weight otherWeight: BlendingWeight) -> simd_float4x2 {
  ...
  public func interpolated(
    at distance: BlendingWeight,
    towards other: simd_float4x2) -> simd_float4x2 {
    return simd_linear_combination(
      (1.0 - distance),
      self,
      distance,
...
// -------------------------------------------------------------------------- //
// MARK: simd_float4x2 - InPlaceBlendable
// -------------------------------------------------------------------------- //

extension simd_float4x2 : InPlaceBlendable {
  ...
  public mutating func becomeInterpolation(
    from start: simd_float4x2,
    to limit: simd_float4x2,
    at distance: BlendingWeight) {
    self = simd_linear_combination(
      (1.0 - distance),
      start,
