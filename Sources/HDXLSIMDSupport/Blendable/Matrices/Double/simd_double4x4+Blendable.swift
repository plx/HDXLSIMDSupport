//
//  simd_double4x4+Blendable.swift
//
...
// -------------------------------------------------------------------------- //
// MARK: simd_double4x4 - Blendable
// -------------------------------------------------------------------------- //

extension simd_double4x4 : Blendable {
  
  public typealias BlendingWeight = NativeSIMDScalar
  
  @inlinable
  public init(
    byBlending first: simd_double4x4,
  ...
  @inlinable
  public init(
    byInterpolatingFrom start: simd_double4x4,
    towards limit: simd_double4x4,
  ...
  public func incorporating(
    ...
    at weight: BlendingWeight) -> simd_double4x4 {
  ...
  public func blended(
    ...
    with other: simd_double4x4,
    weight otherWeight: BlendingWeight) -> simd_double4x4 {
  ...
  public func interpolated(
    at distance: BlendingWeight,
    towards other: simd_double4x4) -> simd_double4x4 {
    return simd_linear_combination(
      (1.0 - distance),
      self,
      distance,
...
// -------------------------------------------------------------------------- //
// MARK: simd_double4x4 - InPlaceBlendable
// -------------------------------------------------------------------------- //

extension simd_double4x4 : InPlaceBlendable {
  ...
  public mutating func becomeInterpolation(
    from start: simd_double4x4,
    to limit: simd_double4x4,
    at distance: BlendingWeight) {
    self = simd_linear_combination(
      (1.0 - distance),
      start,
