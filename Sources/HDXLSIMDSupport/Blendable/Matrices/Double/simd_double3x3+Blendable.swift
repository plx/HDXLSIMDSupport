//
//  simd_double3x3+Blendable.swift
//
...
// -------------------------------------------------------------------------- //
// MARK: simd_double3x3 - Blendable
// -------------------------------------------------------------------------- //

extension simd_double3x3 : Blendable {
  
  public typealias BlendingWeight = NativeSIMDScalar
  
  @inlinable
  public init(
    byBlending first: simd_double3x3,
  ...
  @inlinable
  public init(
    byInterpolatingFrom start: simd_double3x3,
    towards limit: simd_double3x3,
  ...
  public func incorporating(
    ...
    at weight: BlendingWeight) -> simd_double3x3 {
  ...
  public func blended(
    ...
    with other: simd_double3x3,
    weight otherWeight: BlendingWeight) -> simd_double3x3 {
  ...
  public func interpolated(
    at distance: BlendingWeight,
    towards other: simd_double3x3) -> simd_double3x3 {
    return simd_linear_combination(
      (1.0 - distance),
      self,
      distance,
...
// -------------------------------------------------------------------------- //
// MARK: simd_double3x3 - InPlaceBlendable
// -------------------------------------------------------------------------- //

extension simd_double3x3 : InPlaceBlendable {
  ...
  public mutating func becomeInterpolation(
    from start: simd_double3x3,
    to limit: simd_double3x3,
    at distance: BlendingWeight) {
    self = simd_linear_combination(
      (1.0 - distance),
      start,
