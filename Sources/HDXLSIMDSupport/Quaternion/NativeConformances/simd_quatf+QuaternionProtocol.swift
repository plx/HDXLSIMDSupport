...
extension simd_quatf : QuaternionProtocol {
  ...
  public static func slerp(
    ...
    _ q1: simd_quatf,
    _ t: Scalar,
    strategy: QuaternionSlerpStrategy) -> simd_quatf {
    switch strategy {
    case .automatic:
      return simd_quatf.slerpShortest(
        q0,
        q1,
        t
      )
    ...
    case .longest:
      return simd_quatf.slerpLongest(
        q0,
        q1,
        t
      )
  ...
  @inlinable
  public func normalized() -> simd_quatf {
  ...
  @inlinable
  public func inverted() -> simd_quatf {
    return self.inverse
  }
  ...
  @inlinable
  public func conjugated() -> simd_quatf {
  ...
  @inlinable
  public func negated() -> simd_quatf {
    return -self
  }
  ...
  @inlinable
  public func adding(_ other: simd_quatf) -> simd_quatf {
    return self + other
  }
  
  @inlinable
  public mutating func formAddition(of other: simd_quatf) {
    self += other
  }
  ...
  public func adding(
    _ other: simd_quatf,
    multipliedBy factor: Scalar) -> simd_quatf {
  ...
  @inlinable
  public func subtracting(_ other: simd_quatf) -> simd_quatf {
    return self - other
  }
  
  @inlinable
  public mutating func formSubtraction(of other: simd_quatf) {
    self -= other
  }
  ...
  @inlinable
  public func multiplied(by factor: Scalar) -> simd_quatf {
    return self * factor
  }
  ...
  @inlinable
  public func divided(by factor: Scalar) -> simd_quatf {
    return self / factor
  }
  ...
  @inlinable
  public func multiplied(onRightBy other: simd_quatf) -> simd_quatf {
    return self * other
  }
  
  @inlinable
  public func multiplied(onLeftBy other: simd_quatf) -> simd_quatf {
    return other * self
  }
  
  @inlinable
  public mutating func formMultiplication(onRightBy other: simd_quatf) {
    self = self * other
  }
  
  @inlinable
  public mutating func formMultiplication(onLeftBy other: simd_quatf) {
    self = other * self
  }
  ...
  @inlinable
  public func divided(onRightBy other: simd_quatf) -> simd_quatf {
    return self / other
  }
  
  @inlinable
  public func divided(onLeftBy other: simd_quatf) -> simd_quatf {
    return other.inverse * self
  }
  
  @inlinable
  public mutating func formDivision(onRightBy other: simd_quatf) {
    self /= other
  }
  
  @inlinable
  public mutating func formDivision(onLeftBy other: simd_quatf) {
  ...
  @inlinable
  public func dotted(with other: simd_quatf) -> Scalar {
