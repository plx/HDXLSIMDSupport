...
@inlinable
package func crossValidateLHSInPlaceMatrixMatrixMatrixOperation<
  Scalar,
...
>(
  ...
  outOfPlaceOperation: (LHSMatrix, RHSMatrix) throws -> LHSMatrix,
  inPlaceEquivalent inPlaceOperation: (inout LHSMatrix, RHSMatrix) throws -> Void,
  ...
  var inPlaceOutput = matrixLHS
  try inPlaceOperation(&inPlaceOutput, matrixRHS)
...
@inlinable
package func crossValidateLHSInPlaceMatrixMatrixMatrixOperations<
  Scalar,
...
>(
  ...
  for lhs in lhses {
    for rhs in rhses {
      try crossValidateLHSInPlaceMatrixMatrixMatrixOperation(
        arguments: (lhs, rhs),
        operation: operation(),
        metric: metric,
        tolerance: tolerance,
