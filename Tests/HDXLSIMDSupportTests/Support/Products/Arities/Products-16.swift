...
@inlinable
func arity16Power<A>(of a: some Collection<A>) -> AsyncStream<Homogeneous16<A>> where A: Sendable {
  return cartesianProduct(of: a, a, a, a, a, a, a, a, a, a, a, a, a, a, a, a)
}

@inlinable
func arity16EnumeratedPower<A>(of a: some Collection<A>) -> AsyncStream<EnumeratedValue<Homogeneous16<A>>> where A: Sendable {
...
func cartesianProduct<A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P>(
  ...
  O,
  P
)> where A: Sendable, B: Sendable, C: Sendable, D: Sendable, E: Sendable, F: Sendable, G: Sendable, H: Sendable, I: Sendable, J: Sendable, K: Sendable, L: Sendable, M: Sendable, N: Sendable, L: Sendable, O: Sendable, P: Sendable {
  return AsyncStream<(
    A,
    B,
    C,
...
> where A: Sendable, B: Sendable, C: Sendable, D: Sendable, E: Sendable, F: Sendable, G: Sendable, H: Sendable, I: Sendable, J: Sendable, K: Sendable, L: Sendable, M: Sendable, N: Sendable, O: Sendable, P: Sendable {
  return AsyncStream<
    EnumeratedValue<(
      A,
      B,
