...
Scalar.Matrix2x2Storage.NativeSIMDRepresentation: IntegerTupleConstructible
{
  typealias IntegerTuple = NativeSIMDRepresentation.IntegerTuple
}

extension Matrix2x3: IntegerTupleConstructible where
Scalar.Matrix2x3Storage.NativeSIMDRepresentation: IntegerTupleConstructible
{
  typealias IntegerTuple = NativeSIMDRepresentation.IntegerTuple
}

extension Matrix2x4: IntegerTupleConstructible where
Scalar.Matrix2x4Storage.NativeSIMDRepresentation: IntegerTupleConstructible
{
  typealias IntegerTuple = NativeSIMDRepresentation.IntegerTuple
}

extension Matrix3x2: IntegerTupleConstructible where
Scalar.Matrix3x2Storage.NativeSIMDRepresentation: IntegerTupleConstructible
{
  typealias IntegerTuple = NativeSIMDRepresentation.IntegerTuple
}

extension Matrix3x3: IntegerTupleConstructible where
Scalar.Matrix3x3Storage.NativeSIMDRepresentation: IntegerTupleConstructible
{
  typealias IntegerTuple = NativeSIMDRepresentation.IntegerTuple
}

extension Matrix3x4: IntegerTupleConstructible where
Scalar.Matrix3x4Storage.NativeSIMDRepresentation: IntegerTupleConstructible
{
  typealias IntegerTuple = NativeSIMDRepresentation.IntegerTuple
}

extension Matrix4x2: IntegerTupleConstructible where
Scalar.Matrix4x2Storage.NativeSIMDRepresentation: IntegerTupleConstructible
{
  typealias IntegerTuple = NativeSIMDRepresentation.IntegerTuple
}

extension Matrix4x3: IntegerTupleConstructible where
Scalar.Matrix4x3Storage.NativeSIMDRepresentation: IntegerTupleConstructible
{
  typealias IntegerTuple = NativeSIMDRepresentation.IntegerTuple
}

extension Matrix4x4: IntegerTupleConstructible where
Scalar.Matrix4x4Storage.NativeSIMDRepresentation: IntegerTupleConstructible
{
  typealias IntegerTuple = NativeSIMDRepresentation.IntegerTuple
}
